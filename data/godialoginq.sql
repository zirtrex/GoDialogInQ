...
-- -----------------------------------------------------
-- Table `godialoginq`.`tipo_prestamo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `godialoginq`.`tipo_prestamo` (
...
-- -----------------------------------------------------
-- Table `godialoginq`.`prestamo_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `godialoginq`.`prestamo_cliente` (
  ...
  CONSTRAINT `fk_prestamo_cliente_tipo_prestamo`
    ...
    REFERENCES `godialoginq`.`tipo_prestamo` (`idTipoPrestamo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_prestamo_cliente_cliente1`
    FOREIGN KEY (`idCliente`)
    REFERENCES `godialoginq`.`cliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `godialoginq`.`documentacion_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `godialoginq`.`documentacion_cliente` (
  ...
  CONSTRAINT `fk_documentacion_cliente_prestamo_cliente1`
    ...
    REFERENCES `godialoginq`.`prestamo_cliente` (`idPrestamoCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
